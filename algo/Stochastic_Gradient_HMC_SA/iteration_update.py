from algo.Stochastic_Gradient_HMC_SA.optimizers import *
...
class updater():
    ...
    def onestep(self, x, y, burn_in=False, resample_momentum=False, resample_prior=False):
        self.model.train()
        ...
        if self.grad_buff[-1] >= self.max_grad:
            ...
            self.grad_buff.pop() #pop out the last item
